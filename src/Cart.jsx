...
const Cart = () => {
  ...
  return (
    <div className=" mt-16 justify-center gap-36">
      {cart.length>0?(
        <div>
        {cart.map((product) => (
            <div key={product.id} className="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-6 flex items-start mb-2 gap-4">
              <div>
              ...
              <div>
                <div className="w-1/4 flex gap-2 border">
              ...
              <button onClick={() => deletee(product.id)}>delete</button>
